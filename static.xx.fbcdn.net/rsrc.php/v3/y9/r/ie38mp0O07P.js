      ...
      (function (a) {
        ...
        function p(b) {
          ...
          function a(b, d) {
            ...
            if (d == null) {
              ...
              if ((o = typeof b == "number")) {
                ...
                if (a.DEBUG && q.replace(/^0\.0*|\./, "").length > 15)
                  throw Error(i + b);
          ...
          a.config = a.set = function (a) {
            ...
            if (a != null)
              if (typeof a == "object") {
                a.hasOwnProperty((b = "DECIMAL_PLACES")) &&
                  ((c = a[b]), t(c, 0, o, b), (A = c));
                a.hasOwnProperty((b = "ROUNDING_MODE")) &&
                  ((c = a[b]), t(c, 0, 8, b), (B = c));
                a.hasOwnProperty((b = "EXPONENTIAL_AT")) &&
                  ((c = a[b]),
                  c && c.pop
                    ? (t(c[0], -o, 0, b),
                      t(c[1], 0, o, b),
                ...
                a.hasOwnProperty((b = "MODULO_MODE")) &&
                  ((c = a[b]), t(c, 0, 9, b), (H = c));
                a.hasOwnProperty((b = "POW_PRECISION")) &&
                  ((c = a[b]), t(c, 0, o, b), (I = c));
                  ...
                  : o > k ||
                    (o == k &&
                      (q == 4 ||
                        ...
                        q == (m.s < 0 ? 8 : 7)));
              if (h < 1 || !i[0])
                d = l ? w(e.charAt(1), -p, e.charAt(0)) : e.charAt(0);
              else {
                i.length = h;
                if (l)
                  for (--f; ++i[--h] > f; )
                    (i[h] = 0), h || (++j, (i = [1].concat(i)));
                for (k = i.length; !i[--k]; );
                ...
                do {
                  ...
                  if (m < 0) {
                    ...
                    if (o > 1) {
                      ...
                      u = t.length;
                      while (b(v, t, p, u) == 1)
                        o--, d(v, z < p ? A : D, p, l), (p = v.length), (m = 1);
                    } else
                      o == 0 && (m = o = 1), (v = D.slice()), (p = v.length);
                    p < u && (v = [0].concat(v));
                    d(t, v, u, l);
                    u = t.length;
                    if (m == -1)
                      while (b(D, t, z, u) < 1)
                        o++, d(t, z < u ? A : D, u, l), (u = t.length);
                  } else m === 0 && (o++, (t = [0]));
                  s[f++] = o;
          ...
          y.exponentiatedBy = y.pow = function (b, c) {
            ...
            b = new a(b);
            if (b.c && !b.isInteger())
              throw Error(f + "Exponent not an integer: " + P(b));
            c != null && (c = new a(c));
            m = b.e > 14;
            if (
              !p.c ||
            ...
            if (c) {
              ...
              (p.e > 0 ||
                p.e < -1 ||
                (p.e == 0
                  ? p.c[0] > 1 || (m && p.c[1] >= 24e7)
                  : p.c[0] < 8e13 || (m && p.c[0] <= 9999975e7)))
            ) {
              j = p.s < 0 && u(b) ? -0 : 0;
              p.e > -1 && (j = 1 / j);
            ...
            m
              ? ((g = new a(0.5)), n && (b.s = 1), (m = u(b)))
              : ((i = Math.abs(+P(b))), (m = i % 2));
            o = new a(z);
            for (;;) {
              if (m) {
                o = o.times(p);
          ...
          y.multipliedBy = y.times = function (b, c) {
            ...
            c = (b = new a(b, c)).c;
            if (!v || !c || !v[0] || !c[0]) {
              !u.s || !b.s || (v && !v[0] && !c) || (c && !c[0] && !v)
                ? (b.c = b.e = b.s = null)
                : ((b.s *= u.s),
                  !v || !c ? (b.c = b.e = null) : ((b.c = [0]), (b.e = 0)));
              return b;
            }
            e = q(u.e / k) + q(b.e / k);
            b.s *= u.s;
          ...
          y.squareRoot = y.sqrt = function () {
            var b,
              ...
              l = new a("0.5");
            if (i !== 1 || !h || !h[0])
              return new a(!i || (i < 0 && (!h || h[0])) ? NaN : h ? f : 1 / 0);
            i = Math.sqrt(+P(f));
            i == 0 || i == 1 / 0
              ? ((h = r(h)),
                (h.length + j) % 2 == 0 && (h += "0"),
                ...
                if (r(e.c).slice(0, i) === (h = r(c.c)).slice(0, i)) {
                  ...
                  if (h == "9999" || (!d && h == "4999")) {
                    ...
                    (!+h || (!+h.slice(1) && h.charAt(0) == "5")) &&
                      (O(c, c.e + A + 2, 1), (b = !c.times(c).eq(f)));
                    break;
                  }
                }
              }
          ...
          y.toFraction = function (b) {
            ...
            if (b != null) {
              l = new a(b);
              if ((!l.isInteger() && (l.c || l.s !== 1)) || l.lt(z))
                throw Error(
                  f +
                    "Argument " +
            ...
            q =
              g(o, e, i, B)
                .minus(p)
                .abs()
                .comparedTo(g(n, d, i, B).minus(p).abs()) < 1
                ? [o, e]
                : [n, d];
            F = j;
            return q;
          ...
          y.toString = function (b) {
            ...
            f === null
              ? e
                ...
                : (c = "NaN")
              : (b == null
                  ? (c = f <= C || f >= D ? v(r(d.c), f) : w(r(d.c), f, "0"))
                  : b === 10
                  ? ((d = O(new a(d), A + f + 1, B)), (c = w(r(d.c), d.e, "0")))
                  : (t(b, 2, K.length, "Base"),
                    (c = h(w(r(d.c), f, "0"), 10, b, e, !0))),
                e < 0 && d.c[0] && (c = "-" + c));
            return c;
          };
        ...
        typeof h == "function" && h.amd
          ...
          ? (g.exports = b)
          : (a || (a = typeof self != "undefined" && self ? self : window),
            (a.BigNumber = b));
      })(this);
    }
    var j = !1;
      ...
      var a = null,
        ...
        d = function (d) {
          ...
          if (d !== void 0 && d !== null) {
            ...
            e.alwaysParseAsBig =
              d.alwaysParseAsBig === !0 ? d.alwaysParseAsBig : !1;
            e.useNativeBigInt =
              d.useNativeBigInt === !0 ? d.useNativeBigInt : !1;
            if (typeof d.constructorAction !== "undefined")
              if (
                d.constructorAction === "error" ||
                d.constructorAction === "ignore" ||
                d.constructorAction === "preserve"
              )
                e.constructorAction = d.constructorAction;
              else
                throw new Error(
            ...
            if (typeof d.protoAction !== "undefined")
              if (
                d.protoAction === "error" ||
                d.protoAction === "ignore" ||
                d.protoAction === "preserve"
              )
                e.protoAction = d.protoAction;
              else
                throw new Error(
          ...
          var f,
            ...
            j,
            k = function (a) {
              throw { name: "SyntaxError", message: a, at: f, text: j };
            },
            l = function (a) {
            ...
            m = function () {
              ...
              if (!isFinite(b)) k("Bad number");
                ...
                if (Number.isSafeInteger(b))
                  return e.alwaysParseAsBig
                    ? e.useNativeBigInt
                      ? BigInt(b)
                      : new a(b)
                    : b;
                else
                  return e.storeAsString
                    ? c
                    : /[\.eE]/.test(c)
                    ? b
                    : e.useNativeBigInt
            ...
            s = function () {
              ...
              if (h === "{") {
                ...
                while (h) {
                  ...
                  l(":");
                  e.strict === !0 &&
                    Object.hasOwnProperty.call(a, d) &&
                    k('Duplicate key "' + d + '"');
                  b.test(d) === !0
                    ? e.protoAction === "error"
                      ? k("Object contains forbidden prototype property")
                      : e.protoAction === "ignore"
                      ? q()
                      : (a[d] = q())
                    : c.test(d) === !0
                    ? e.constructorAction === "error"
                      ? k("Object contains forbidden constructor property")
