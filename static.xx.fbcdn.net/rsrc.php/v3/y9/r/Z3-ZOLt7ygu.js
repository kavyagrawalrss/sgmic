...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      d.$2 = function () {
        this.$1 == null &&
          (this.$1 = new (h || (h = b("Promise")))(function (a) {
        ...
        if ((h || (h = c("URI"))).isValidURI(window.location.href)) {
          ...
          j(a)
            ...
            ? ((this.$1 = "gateway.facebookenterprise.com"),
              (this.$2 = "ENTERPRISEFB"))
            : o(a)
            ? ((this.$1 = "gateway.metaenterprise.com"),
              (this.$2 = "ENTERPRISEFB"))
            : p(a)
            ...
            : s(a)
            ? ((this.$1 = "gateway.threads.net"), (this.$2 = "INSTAGRAM"))
            : q(a)
            ...
            : m(a)
            ? ((this.$1 = "gateway.horizon.meta.com"),
              (this.$2 = "HORIZON_WEB"))
            : u(a) &&
              ((this.$1 = "gateway.spark.meta.com"), (this.$2 = "SPARK_WEB"));
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      e.createStream = function (a, e, f, g, i) {
        var j = d("TransportSelectingClientUtils").getMethodContextForCC(
          a.method,
          a.topic
        );
        if (this.$2[j]) {
          g.onTermination(
            "RequestStream method " + j + " has been throttled on this client"
          );
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    a = (function () {
      function a() {
        (this.$1 = null),
          c("DGWRequestStreamDeferredClient") != null &&
            (this.$2 = new (c("ThrottlingClient"))(
              c("DGWRequestStreamDeferredClient")
            ));
      }
      var e = a.prototype;
