  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      d.patchRequestHeaders = function (a) {
        ...
        if (
          !(h || (h = c("isEmpty")))(c("WebDriverConfig").auxiliaryServiceInfo)
        ) {
          var g;
          g =
          ...
          g != null
            ? (typeof g.ip_address === "string"
                ? (d[j] = g.ip_address + ":18295")
                : typeof g.hostname === "string" &&
                  (d[j] = g.hostname + ":18295"),
              typeof c("WebDriverConfig").originHost === "string" &&
                (d[k] = "www." + c("WebDriverConfig").originHost))
            : e != null && (d[i] = e);
        } else e != null && (d[i] = e);
        f === !0 && (d[l] = "intern");
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    var h,
      i = "bladerunner_js_client",
      j = { info: "info", warning: "warning", exception: "exception" };
    a = (function () {
      function a() {
      ...
      var b = a.prototype;
      b.info = function (a) {
        this.$2 >= 2 && c("FBLogger")(i).info("BladeRunner info: %s", a),
          this.$3(j.info, a);
      };
      b.warn = function (a) {
        this.$2 >= 1 && c("FBLogger")(i).warn("BladeRunner warn: %s", a),
          this.$3(j.warning, a);
      };
      ...
      b.bumpCounter = function (a, b) {
        b === void 0 && (b = 1),
          (h || (h = d("ODS"))).bumpEntityKey(2966, "BladeRunnerClient", a, b);
      };
  ...
  function (a, b, c, d, e, f, g) {
    ...
    e = (function () {
      ...
      a.createSocket = function (a, b) {
        return this.$7 != null
          ? this.$7(a, b)
          : d("MqttEnvWebSocket").createWebSocket(a);
      };
...
__d(
  "MetaConfig",
  ["invariant", "BanzaiLazyQueue", "ExecutionEnvironment", "MetaConfigMap"],
  function (a, b, c, d, e, f, g, h) {
    ...
    a = {
      _: function (a) {
        ...
        b != null &&
          j[a] !== !0 &&
          ((i || (i = c("ExecutionEnvironment"))).isInBrowser &&
            d("BanzaiLazyQueue").queuePost("metaconfig_exposure", {
              identifier: a,
              log_id: b,
            }),
          (j[a] = !0));
        ...
        e.$CrossWindowEventEmitter1.addValueChangeCallback(function (c, d, f) {
          ...
          if (c && c.__v) {
            (f = a.prototype.emit).call.apply(
              f,
              [babelHelpers.assertThisInitialized(e), d].concat(c.__v)
            );
          }
        });
        return e;
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function j(a, b) {
      ...
      if (i == null) return { position: e, wireMessage: null };
      b = i.offset;
      i = b + i.value;
      if (i > a.length) return { position: e, wireMessage: null };
      var j;
      switch (g) {
        case h.CONNACK:
          e = a[b++];
      ...
      return { position: i, wireMessage: j };
    }
    function a(a) {
      var b = [],
        c = 0;
    ...
    f = (function (a) {
      ...
      c.encode = function () {
        ...
        b = a.writeString(
          ...
          a.UTF8Length(this.connectOptions.userName),
          f,
          b
        );
        return c;
...
__d(
  "MqttProtocolClient",
  ["MqttEnv", "MqttProtocolCodec", "MqttProtocolUtils", "MqttTypes", "err"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    var h = 20,
      i = 6e4;
      ...
      b.connect = function (a) {
        ...
        this.$6.onopen = function () {
          b.setConnected(!0),
            ...
            (b.$11 = b.$13(
              new (d("MqttProtocolCodec").WireMessage.Connect)(b.$1, a)
            )),
            a.onConnection();
        };
        this.$6.onmessage = function (a) {
          ...
          try {
            a = new Uint8Array(a);
            b.$10 != null &&
              ((a = d("MqttProtocolUtils").concatBuffers(b.$10, a)),
    ...
    a = (function () {
      function a(a, b, c, e, f, g, h, i, j, k, l) {
        h === void 0 && (h = null),
          ...
          (this.$5 = f),
          (this.$6 = g),
          (this.$7 = d("MqttUserNameUtils").getMqttForegroundStatus()),
          (this.$8 = h),
          (this.$9 = i),
          (this.$10 = j),
          (this.$11 = k),
      ...
      b.gen = function (a, b, c, e) {
        ...
        c = c.map(function (a) {
          ...
          typeof a.payload !== "string" &&
            ((a.payload = btoa(String.fromCharCode.apply(null, a.payload))),
            (a.isBase64Publish = !0));
          return a;
        });
        f = {
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      e.$32 = function (a, e, f, g) {
        var i = { reject: function (a) {}, resolve: function () {} };
        g != null && (i.listener = g);
        ...
        !k
          ? (g == null
            ...
            i.reject(c("err")("Client disconnected")))
          : this.$33(a, e, f, i);
        return j;
      };
      ...
      e.$28 = function () {
        ...
        g = d("MqttUtils").endpointWithExtraParameter(
          g,
          "cid",
          this.$6.getDeviceId()
        );
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      e.$26 = function (a, b, c) {
        ...
        var e;
        c.qos === 0
          ? (e = this.$27(a, b, c.listener))
          : (e = this.$28(a, b, c));
        d("MqttUtils").promiseDone(
          e,
          function () {},
          function (a) {
            (a = c.listener) == null
      ...
      e.$28 = function (a, c, e) {
        var f = { reject: function (a) {}, resolve: function () {} },
        ...
        if (e.skipBuffer)
          if (this.$10.connectionState() === "Connecting") {
            ...
            (a = e.listener) == null
              ? void 0
              : a.onEvent(d("MqttPublishListener").MqttPublishEvent.QUEUED);
          } else this.$30(c);
        else {
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    function a() {
      return c("CurrentEnvironment").instagramdotcom
        ? c("CurrentUser").getEIMU()
        : c("CurrentUser").getID();
    }
    function b() {
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function b(a, b) {
      ...
      d &&
        (b == null
          ? d.removeItem(i + a)
          : (h || (h = c("WebStorage"))).setItemGuarded(d, i + a, b));
    }
    g.configRead = a;
    g.configWrite = b;
  },
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      function a() {
        (this.$1 = d("LogHistory").getInstance(j)),
          (this.$2 = 0),
          (this.$3 = Date.now()),
          (this.$4 = c("ChannelClientID").getID()),
          this.$6(),
          (this.$5 = d("MqttGlobalStreamCounter").getInstance()),
      ...
      b.eventLogConnect = function (a) {
        ...
        var s = {
          ...
          ws_count:
            (j = this.$5) == null
              ? void 0
              : j.getGlobalState().totalConnectionStreams.toString(),
        };
        this.$7(function () {
      ...
      b.eventLogDisconnect = function (a) {
        ...
        var f = {
          ...
          ws_count:
            (b = this.$5) == null
              ? void 0
              : b.getGlobalState().totalConnectionStreams.toString(),
        };
        this.$7(function () {
      ...
      b.eventLogOutgoingPublish = function (a) {
        ...
        var q = Date.now(),
          r = {
            ...
            extra_data: { device_id: this.$4, protocol: i },
            os_connectivity: this.getBrowserConnectivity(),
      ...
      b.bumpCounter = function (a) {
        ...
        d("MqttEnv").Env.scheduleLoggingCallback(function () {
          b.$2 !== 0 &&
            ...
            (h || (h = d("ODS"))).bumpEntityKey(2966, "mqtt_ws_client", a, k);
        });
      };
      b.$8 = function (a, b, e) {
        var f = this;
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a() {
      d("MqttEnv").Env.initialize(
        c("Random").random,
        d("CurrentMessengerUser").isLoggedInNow,
        c("clearTimeout"),
        ...
        null,
        null,
        d("MqttEnvConfigStorage").configRead,
        d("MqttEnvConfigStorage").configWrite
      );
    }
    b = { genGk: c("MqttEnvGk"), initialize: a };
    g["default"] = b;
  },
  98
);
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      e.$16 = function () {
        var a = !1;
        if (this.$7.getConnectionState() === i && this.$1.length > 0)
          try {
            this.$20(this.$1), (a = !0);
          } catch (a) {
          } finally {
      ...
      e.$20 = function (a) {
        ...
        if (f.length > this.$21()) {
          ...
          try {
            c("BladeRunnerLogger").info(
              "send message to " + k + " (" + f.length + " bytes)"
            );
    ...
    b = (function () {
      ...
      b.readFieldBegin = function () {
        var a = this.$1.readByte(),
          b = a & 15;
        if (b === (h || (h = c("ThriftTypes"))).STOP)
          return { ftype: (h || (h = c("ThriftTypes"))).STOP, fid: 0 };
        a = (a & 240) >>> 4;
        var d;
        a === 0 ? (d = this.readI16()) : (d = this.$3 + a);
        a = this.$10(b);
        (b === i.CT_BOOLEAN_TRUE || b === i.CT_BOOLEAN_FALSE) &&
          (this.$5 = b === i.CT_BOOLEAN_TRUE);
        this.$3 = d;
      ...
      b.readBool = function () {
        ...
        this.$5 != null
          ...
          : (a = this.$1.readByte() === i.CT_BOOLEAN_TRUE);
        return a;
      };
      b.writeBool = function (a) {
        ...
        this.$4 != null
          ? ((b += this.$7(
              this.$4,
              a ? j.CT_BOOLEAN_TRUE : j.CT_BOOLEAN_FALSE
            )),
            (this.$4 = null))
          : (b += this.$1.writeByte(
      ...
      b.i64ToZigzag = function (a) {
        if (c("jsbi").greaterThan(a, s) || c("jsbi").lessThan(a, t))
          throw new Error("i64 out of range: " + a.toString());
        return c("jsbi").bitwiseXor(
          c("jsbi").signedRightShift(a, v),
          c("jsbi").leftShift(a, w)
        );
      };
      b.zigzagToI64 = function (a) {
        if (c("jsbi").lessThan(a, 0) || c("jsbi").greaterThan(a, u))
          throw new Error("invalid uint64: " + a.toString());
        return c("jsbi").equal(c("jsbi").bitwiseAnd(a, w), w)
          ? c("jsbi").bitwiseNot(c("jsbi").signedRightShift(a, w))
          : c("jsbi").signedRightShift(a, w);
      };
      ...
      b.writeVarint64 = function (a) {
        if (c("jsbi").lessThan(a, x) || c("jsbi").greaterThan(a, u))
          throw new Error("invalid uint64: " + a.toString());
        a = a;
        var b = 0;
        while (!0)
          if (c("jsbi").equal(c("jsbi").signedRightShift(a, y), x)) {
            ...
            var d,
              e = (d = c("jsbi")).toNumber(d.bitwiseOr(d.bitwiseAnd(a, A), B));
            this.$1.writeByte(e);
            b++;
      ...
      b.readVarint64 = function () {
        ...
        while (!0) {
          ...
          if (c("jsbi").equal(c("jsbi").bitwiseAnd(d, B), x)) {
            if (c("jsbi").equal(b, z) && c("jsbi").notEqual(d, w))
              throw new Error("result exceeded 64 bit limit");
            break;
          }
          if (c("jsbi").greaterThan(b, v))
            throw new Error("result exceeded 64 bit limit");
        }
        return a;
      };
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a, d, e, f) {
      ...
      if (c("WebDriverConfig").isTestRunning && c("gkx")("20919")) {
        ...
        j != null &&
          ((g["XRSB-is_test"] = "true"), (g["XRSS-original_request_id"] = j));
      }
      return g;
    }
    function h(a) {
...
__d(
  ...
  function (a, b, c, d, e, f) {
    ...
    function n(a, c) {
      c.writeStructBegin("ResponseRewriteRequest"),
        ...
        a.conditional_patch_headers != null &&
          ...
          o(a.conditional_patch_headers, c),
          c.writeFieldEnd()),
        c.writeFieldStop(),
        c.writeStructEnd();
    }
    ...
    function t(a, c) {
      ...
      c.writeFieldEnd();
      c.writeFieldBegin({ fname: "last_sequencer", ftype: g.I32, fid: 2 });
      ...
      c.writeFieldEnd();
      c.writeFieldBegin({ fname: "amendment_count", ftype: g.I32, fid: 4 });
      ...
      c.writeFieldEnd();
      c.writeFieldBegin({ fname: "last_status", ftype: g.I32, fid: 3 });
    ...
    function u(a, c) {
      ...
      if (a.streams_to_check != null) {
        ...
        c.writeListBegin({ etype: g.STRUCT, size: a.streams_to_check.length });
        for (
    ...
    function v(a, c) {
      ...
      if (a.stream_ids_missing != null) {
        ...
        c.writeListBegin({ etype: g.I64, size: a.stream_ids_missing.length });
        for (
      ...
      if (a.stream_ids_behind != null) {
        ...
        c.writeListBegin({ etype: g.I64, size: a.stream_ids_behind.length });
        for (
          h = a.stream_ids_behind,
            f = Array.isArray(h),
            e = 0,
            h = f
              ? h
      ...
      if (a.stream_ids_with_wrong_status != null) {
        ...
        for (
          h = a.stream_ids_with_wrong_status,
            f = Array.isArray(h),
            e = 0,
            h = f
              ? h
      ...
      while (!0) {
        ...
        switch (d) {
          ...
          case 5:
            ...
            break;
          case 6:
            e === (g || (g = b("ThriftTypes"))).STRUCT
              ? (c.conditional_patch_headers = y(a))
              : a.skip(e);
            break;
          default:
            a.skip(e);
    ...
    function n(a, c) {
      ...
      if (a.delta != null) {
        ...
        for (
          ...
          b(
            "RequestStreamCommonRequestStreamCommonSerializers"
          ).serializeStreamResponseDelta(h, c);
        }
        c.writeListEnd();
      } else {
        h = [];
      ...
      while (!0) {
        ...
        switch (e) {
          case 1:
            if (f === (g || (g = b("ThriftTypes"))).STRUCT)
              if (c == null)
                (d.request_headers = p(a)), (c = "request_headers");
              else
                throw new Error(
    ...
    a = (function () {
      ...
      e.amendWithAck = function (a) {
        ...
        return a === null || a === void 0
          ? (h || (h = b("Promise"))).resolve(!1)
          : this.$19.getPromise(a) || (h || (h = b("Promise"))).resolve(!1);
      };
              ...
              switch ((n.prev = n.next)) {
                case 0:
                  ...
                  return b("regeneratorRuntime").awrap(
                    this.$20.establishStream(j, h, this.$7)
                  );
                case 8:
                  this.$11 = n.sent;
                  n.next = 23;
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var i = b("$InternalEnum")({
      ...
      j = { VERBOSE: -1, INFO: 0, WARNING: 1, ERROR: 2, FATAL: 3 };
    function k(a) {
      switch (a) {
    ...
    e = (function () {
      ...
      b.$8 = function (a, b, d, e, f, g) {
        ...
        g === void 0 && (g = !1);
        if (g && !this.$7) return;
        ((k(a) && this.$1 != null) || (!k(a) && this.$6 != null)) &&
  ...
  function (a, b, c, d, e, f, g) {
    ...
    e = (function () {
      ...
      a.constructConnectUrl = function (a) {
        ...
        var t =
          ((b = {}),
          (b[(e = d("DGWConstants")).HEADER_CONSTANTS.HEADER_APPID] = f),
          (b[e.HEADER_CONSTANTS.HEADER_APPVERSION] = g),
          (b[e.HEADER_CONSTANTS.HEADER_AUTHTYPE] = i),
          (b[e.HEADER_CONSTANTS.HEADER_DGW_VERSION] = "" + l),
          (b[e.HEADER_CONSTANTS.HEADER_UUID] = m),
          (b[e.HEADER_CONSTANTS.HEADER_TARGET_TIER] = n),
          b);
        a !== void 0 &&
          (t[
            d(
        ...
        o !== void 0 &&
          (t[d("DGWConstants").HEADER_CONSTANTS.HEADER_LOGGING_ID] = o);
        s !== void 0 &&
          (t[d("DGWConstants").HEADER_CONSTANTS.HEADER_REGIONHINT] = s);
        j !== void 0 &&
          (t[d("DGWConstants").HEADER_CONSTANTS.HEADER_DEVICE_ID] = j);
      ...
      e.processData = function () {
        ...
        if (this.$1 && this.$1.length > h) {
          this.$1 = new Uint8Array(
            ((b = this.$1) == null ? void 0 : b.subarray(h)) || []
          );
        } else this.$1 = null;
              ...
              e = (function () {
                var b = l.__getStreamIdFromStreamGroupFrame(m),
                  ...
                  d = new Uint8Array(
                    l.HEAPU8.subarray(
                      c,
                      c + l.__getEncodedParamsSizeFromEstablishStreamFrame(m)
                    )
                  );
                a.free(c);
                k.push(function () {
              ...
              h = (function () {
                var b = l.__getStreamIdFromStreamGroupFrame(m),
                  ...
                  d = new Uint8Array(
                    l.HEAPU8.subarray(
                      c,
                      c + l.__getDataSizeFromGroupedStreamDataFrame(m)
                    )
                  );
                a.free(c);
                var e = l.__getRequiresAckFromGroupedStreamDataFrame(m)
                  ? l.__getAckIdFromGroupedStreamDataFrame(m)
                  : null;
                k.push(function () {
                  var c;
                  return (c = a.$3) == null
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      b.$6 = function () {
        ...
        if (this.$3) {
          var b;
          (b = d("DGWLoggingContext")).DGWLoggingContext.bumpODSKey(
            b.DGWLoggingComponent.PINGER,
            "timeout_fired.reset"
          );
          this.$3 = !1;
          this.$4();
          b.DGWLoggingContext.bumpODSKey(
            b.DGWLoggingComponent.PINGER,
            "timeout.newtimeout"
          );
            ...
            while (1)
              switch ((g.prev = g.next)) {
                case 0:
                  ...
                  g.next = 5;
                  return b("regeneratorRuntime").awrap(
                    new (h || (h = b("Promise")))(function (b, d) {
                      e.set(a, new i(a, c, b));
                    })
                  );
                case 5:
            ...
            while (1)
              switch ((m.prev = m.next)) {
                case 0:
                  ...
                  m.next = 5;
                  return b("regeneratorRuntime").awrap(
                    new (h || (h = b("Promise")))(function (b, c) {
                      j.$6.set(
                        a,
                        new i(k, b, c, 3e4, function () {
              ...
              switch ((l.prev = l.next)) {
                ...
                case 15:
                  this.$2.containsStreamGroup(this.$1) ||
                    this.$2.setStreamGroupAndTransport(this.$1, j);
                  l.next = 23;
                  break;
                case 18:
                  l.next = 20;
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h;
    a = function (a) {
      return (h || (h = c("ContextualConfigAssert")))(
        a > 0,
    ...
    function a(a, b, e, f) {
      var g = e.map(
          f
            ...
            : h || (h = c("ContextualConfigParseFloat"))
        ),
        i;
      switch (b) {
        case d("ContextualConfigConstants").CONTEXT_BUCKET_STRATEGY.SAME:
          var j = f
            ...
            : (h || (h = c("ContextualConfigParseFloat")))(a);
          i = function (a) {
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h,
      ...
      k = d("ContextualConfigValidators").isKey(
        d("ContextualConfigConstants").CONTEXT_BUCKET_STRATEGY
      ),
      l = function (a) {
        return (h || (h = c("ContextualConfigAssert")))(
          d("ContextualConfigValidators").isString(a) && k(a.toUpperCase()),
    ...
    var h,
      ...
      o = function (a) {
        return function (b) {
          ...
          var e = n(a, d);
          m(e);
          b = (i || (i = c("ContextualConfigParseResultParamValue")))(
            e,
            b.value
          );
  ...
  function (a, b, c, d, e, f, g) {
      ...
      l = function (a, b, d) {
        try {
          d = d.reduce(function (b, d, e) {
            (
              h || (h = c("ContextualConfigAssert"))
            )(e < a.length, "Auxillery index out of range.");
            return b + a[e] * d;
          }, 0);
          return [null, d * b];
        } catch (a) {
    ...
    a = (function () {
      ...
      b.unsafeResolve = function (a) {
        ...
        b = m[1];
        return g != null
          ? [g, j, f, d("ContextualConfigConstants").EMPTY_RESOLVED_MONITORS]
          : [null, j, f, b];
      };
      return a;
    })();
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      e.run = function (a, b, c, e, f, g, h, i) {
        (this.$1 = d("MqttUtils").endpointWithSessionId(a, b)),
          (this.$3 = b),
          (this.$4 = c),
          (this.$5 = e),
          (this.$6 = f),
      ...
      e.$23 = function (a) {
        var b = this;
        a.forEach(function (a) {
          b.$2.bumpCounter(k + "publish." + a.topic + ".resolved"),
      ...
      e.$24 = function (a, b) {
        var c = this;
        a.forEach(function (a) {
          c.$2.bumpCounter(k + "publish." + a.topic + ".rejected"),
      ...
      e.$25 = function (a, b, c, d) {
        ...
        this.$14 !== "ReceivingData" || c === q
          ? (this.$24(a, d),
            (this.$18 = !1),
            this.$2.bumpCounter(k + "publish_request_failed_final"),
            this.$22())
          : this.$26(a, b, c + 1);
      };
      ...
      e.$26 = function (a, b, c) {
        ...
        this.$2.debugTrace(
          "FetchClient",
          "Fetch publish request sent. Publishes:" + f + ", retry:" + c
        );
        ...
        d("MqttUtils").promiseDoneWithTimeout(
          u.fetch(f, {
            method: "POST",
            mode: "cors",
            cache: "no-cache",
      ...
      e.$32 = function (a) {
        ...
        for (
          ...
          h = h;
          this.$2.bumpCounter(
            k + "response_" + ((h = h.topic) != null ? h : "void")
          );
        }
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      e.$29 = function () {
        var a,
          b = (a = d("MqttEnv")).Env.genGk(a.MqttGkNames.mqtt_lp_no_delay),
