...
(function (a) {
    ...
    while (a.length) {
      ...
      if (f.dependencies)
        for (c = 0; c < f.dependencies.length; c++)
          (g = f.dependencies[c]), U(g) || a.push(g.id);
    }
  ...
  function Q() {
    ...
    Object.keys(N).length > 0 &&
      (O = setTimeout(Z()(Q, "_checkFbtVirtualModuleTimeout"), P));
  ...
  var R = [
    ...
    ja = ["IFBT", "isFbtTranslated"];
  function ka(a, b, c) {
    if (!M) return;
    if (R.indexOf(a) !== -1 || ja.indexOf(a) !== -1) return;
  ...
  function S(b, c, e, g, h, i, l, m) {
    ...
    M && (b in N && delete N[b], Array.isArray(c) && ka(b, c, m));
    f[b] = {
      id: b,
      dependencies: c,
      meta: l,
    ...
    o.context = h;
    o.special = g;
    (o.nonJSDeps || va(o)) && ((o.nonJSDeps = !1), K(o));
    V(o);
    if (d.length > 0) {
      var p = d;
      d = [];
      l = a.ScheduleJSWork ? a.ScheduleJSWork : za;
      l(function () {
        if (v) {
  ...
  b = [
    D.call(null, "global"),
    D.call(null, "require"),
    D.call(null, "requireDynamic"),
    D.call(null, "requireLazy"),
    D.call(null, "requireInterop"),
    null,
  ];
  c = [
    D.call(null, "global"),
    D.call(null, "require"),
    D.call(null, "importDefault"),
    D.call(null, "importNamespace"),
    D.call(null, "requireLazy"),
    D.call(null, "requireInterop"),
    null,
  ];
  ...
  W("__getTotalRequireCalls", fa);
  W("__getModuleTimeDetails", ga);
  W("__debug", $);
...
__d(
  ...
  ["ExecutionEnvironment", "err", "unrecoverableViolation"],
  function (a, b, c, d, e, f, g) {
    var h;
    function b() {
      if (
...
__d(
  "NetworkHeartbeat",
  ["clearTimeout", "getSameOriginTransport", "killswitch", "setTimeout"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    var h = "/nw/",
      i = 6400,
  ...
  function (a, b, c, d, e, f) {
    ...
    function h(c) {
      !(g || (g = b("Env"))).isCQuick
        ...
        : b("cr:7936").sendMessage({ compatAction: "reload" });
    }
    function c(b) {
      a.setTimeout(h, b);
    }
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h,
      i,
      j = new (c("BootloaderRetryTracker"))({
        retries:
...
__d(
  "CookieConsent",
  ["CookieConsentIFrameConfig", "InitialCookieConsent", "gkx"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    var h,
      ...
      k = {
        ...
        isThirdPartyIframeAllowed: function (a) {
          if (!k.isFirstPartyStorageAllowed()) {
            var b =
              c("CookieConsentIFrameConfig").is_checkpointed &&
              c("gkx")("20939");
            if (!b) return !1;
          }
...
__d(
  "TrustedTypesBigPipeMarkupPolicy",
  ["TrustedTypes"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    a = {
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function b() {
      for (var b = arguments.length, d = new Array(b), e = 0; e < b; e++)
        d[e] = arguments[e];
      if (
        c("TrustedTypes").isSupportedNatively() &&
        (h || (h = c("Env"))).useTrustedTypes
      ) {
...
__d(
  "UserTimingUtils",
  ["performance", "regeneratorRuntime"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    var h,
      i =
  ...
  function (a, b, c, d, e, f, g) {
      ...
      if (a)
        for (var e = 0; e < a.length; e++) {
          var f = null,
            ...
            h = g.match(/^\"caller:([^\"]+?)\";(.*)/);
          h != null && ((f = h[1]), (g = h[2]));
          (i || (i = c("ErrorUtils"))).applyWithGuard(
            d(
              "TrustedTypesUnsafeFunctionScriptPolicy_DO_NOT_USE"
            ).createTrustedFunction(
              c("TrustedTypesNoOpPolicy_DO_NOT_USE").createScript(g)
            ),
            b
          );
    ...
    e = (function () {
      function a(e) {
        ...
        this.automatic
          ? (this._relevant_instance =
              d("BigPipeInstance").getCurrentInstance())
          : d("BigPipeInstance").setCurrentInstance_DO_NOT_USE(this);
      ...
      e._displayPagelet = function (a) {
        ...
        for (var f in a.content) {
          ...
          if (g) {
            if (a.append) r(h, g, d);
              ...
              (h.innerHTML = c("TrustedTypesBigPipeMarkupPolicy").createHTML(
                ""
              )),
                r(h, g, d);
            else {
            ...
            c("BigPipeExperiments").enable_bigpipe_plugins &&
              c("BigPipePlugins").runPluginOnPagelet(h);
          }
        ...
        if (a.static_templates) {
          ...
          g &&
            ((i = p(a.static_templates)),
            a.replace_static_templates_if_exists && (i = s(g, i, d)),
            r(g, i, d));
        }
        ...
        j.length > 0 &&
          this._informEventExternal("images_displayed", {
            pagelet: a.id,
            timeslice: c("TimeSlice").getContext()
              ? c("TimeSlice").getContext().contextID
              : null,
            images: j,
          });
      ...
      e._onPhaseDisplayEnd = function (b) {
        ...
        this._isRelevant() &&
          (b === this._lastPhaseBeforeLastResponse &&
            this._fireDisplayDone(function () {}),
          b === this._lastPhaseOfLastResponse &&
            (this._displayDoneFired || this._fireDisplayDone(function () {}),
      ...
      e._downloadJsForPagelet = function (a) {
        ...
        c("Bootloader").loadResources(a.allResources || [], {
          onAll: function () {
            ...
            var d = function () {
                b._informPageletEvent(
                  c("PageletEventConstsJS").ONLOAD_START,
                  a
                ),
                  b._isRelevantPagelet(a) && n(a.onload),
                  b._informPageletEvent(
      ...
      e._informEventExternal = function (a, b, d) {
        (b = b || {}),
          (d = d || this.arbiter),
          b.ts || (b.ts = (h || (h = c("performanceAbsoluteNow")))()),
          k &&
            console.timeStamp &&
            console.timeStamp(
              a +
                " " +
                (Object.prototype.hasOwnProperty.call(b, "arbiter")
                  ? JSON.stringify(
                      babelHelpers["extends"]({}, b, { arbiter: null })
                    )
                  : JSON.stringify(b))
            ),
          this.lid === null
            ? this._awaitingLIDEventQueue.push([d, a, b])
            : ((b.lid = this.lid), d.inform(a, b, "persistent"));
      };
      ...
      e._informPageletDisplayDetails = function (a, b, d, e) {
        if (this.config.dispatch_pagelet_replayable_actions)
          try {
            ...
            c("FBLogger")("bigpipe_pagelet_replay")
              .catching(a)
    ...
    Object.assign(e.prototype, {
      beforePageletArrive: function (a, b) {
        ...
        c("TimeSlice").guard(
          function () {
            return d._informPageletEvent(
              c("PageletEventConstsJS").ARRIVE_START,
              { id: a },
              b
            );
          },
      ...
      onPageletArrive: (i || (i = c("ErrorUtils"))).guard(function (a) {
        ...
        if (a.jsmods) {
          ...
          this._informPageletDisplayDetails(
            a.id,
            { define: g, instances: b, markup: i, pre_display_requires: h },
            {}
          );
        ...
        if (a.display_group) {
          ...
          for (i = 0; i < b.length; i++) {
            h = b[i];
            if (h.id === a.id) break;
            h.getAttribute("data-display-group") === a.display_group &&
              l.push(h.id + "_displayed");
          }
        }
        ...
        m = function () {
          ...
          c("Bootloader").loadResources(b, {
            onAll: function () {
              e._informPageletEvent(c("PageletEventConstsJS").CSS_END, a),
                e.arbiter.inform(a.id + "_css_end", !0, "state");
            },
          });
        };
        this.config.flush_pagelets_asap
          ? m()
          : this.arbiter.registerCallback(m, ["phase_begin_" + f]);
        g = [a.id + "_displayed"];
          ...
          if ((i || (i = c("Env"))).isCQuick) {
            ...
            a = (function () {
              ...
              if (
                ...
                (c("gkx")("20836") || e.getSubdomain() !== d.getSubdomain())
              ) {
    ...
    var g = b("EventConfig").sampling || {},
      h = {
        ...
        getEventSampleWeights: function (a) {
          a.__samplingWeights == null &&
            (a.__samplingWeights = { event: i(h.getEventWeight(a)) });
...
__d(
  ...
  function (a, b, c, d, e, f) {
        ...
        return function (c, d) {
          ...
          i[t] === void 0 && !v
            ? ((w = b("getParentClassesForEventProfiler")(d.target)),
              ...
              (u = a.call(this, c, d)),
              (j[t] = b("TimeSlice").getGuardedContinuation(
          ...
          if (i[t] === void 0) {
            ...
            var A =
              z &&
              (!!d.deliberateSync || b("UserAgent").isBrowser("Chrome < 51"));
            i[t] = {
              event_name: c,
            ...
            b("requestAnimationFrameAcrossTransitions")(function () {
              ...
              i[t].request_animation_frame_wait_ms = Math.round(
                a - h[t].event_end_ms
              );
    ...
    function r(a) {
      return o != null
        ? o.getEventSampleWeights(a)
        : b("EventProfilerSampler").getEventSampleWeights(a);
    }
    e.exports = c;
  },
  null
...
__d(
  ...
  function (a, b, c, d, e, f) {
    ...
    d &&
      (d.addEventListener
        ? (d.addEventListener("focus", a, !0),
          d.addEventListener("blur", a, !0))
...
__d(
  ...
  function (a, b, c, d, e, f, g, h) {
    var i,
      j = (i || c("ExecutionEnvironment")).canUseDOM
    ...
    function a(a) {
      ...
      Object.prototype.hasOwnProperty.call(k, a) ||
        (a === "*"
          ? (j.innerHTML = c("TrustedTypesLinkTagHTMLPolicy").createHTML(
              "<link />"
            ))
          : (j.innerHTML = "<" + a + "></" + a + ">"),
        (k[a] = !j.firstChild));
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function ga(a, b, c) {
      ...
      a
        ...
        : n(!!a, "Could not get extension for the object");
      return c;
    }
    var A = "__ext",
      B = function () {},
      ...
      C = (function (b) {
        ...
        c.onBeforeCallMapperAdd = function (a) {
          this.onBeforeCallMapper ||
            ((this.onBeforeCallMapper = new ha()), this.updateDispatcherFunc());
        ...
        c.onBeforeCallObserverAdd = function (a) {
          this.onBeforeCallObserver ||
            ((this.onBeforeCallObserver = new ia()),
            this.updateDispatcherFunc());
        ...
        c.onAfterCallMapperAdd = function (a) {
          this.onAfterCallMapper ||
            ((this.onAfterCallMapper = new ja()), this.updateDispatcherFunc());
        ...
        c.onAfterCallObserverAdd = function (a) {
          this.onAfterCallObserver ||
            ((this.onAfterCallObserver = new ka()),
            this.updateDispatcherFunc());
        ...
        c.onBeforeAndAfterCallMapperAdd = function (a) {
          this.onBeforeAndAterCallMapper ||
            ((this.onBeforeAndAterCallMapper = new la()),
            this.updateDispatcherFunc());
    ...
    var M = (function () {
        ...
        b.interceptObjectItself = function (a) {
          ...
          if (this.pendingPropertyInterceptors)
            for (
              var b = this.pendingPropertyInterceptors,
                c = Array.isArray(b),
                d = 0,
                b = c
                  ? b
    ...
    var U = I("catch", i),
      V = I("finally", i);
    j =
      (j = v(k || (k = b("Promise")))) != null
        ? j
        : w(k || (k = b("Promise")), new M(k || (k = b("Promise")), null));
    var W = I("all", j),
      X = I("allSettled", j),
      Y = I("any", j),
      Z = I("race", j),
    ...
    var G = (function () {
      ...
      aa = (function (b) {
        ...
        function a(a, c, e) {
          ...
          y.setVirtualProperty(
            a,
            new G(c.raw, babelHelpers.assertThisInitialized(c))
          );
          H();
          return c;
        }
  ...
  function (a, b, c, d, e, f, g) {
        ...
        c("Bootloader").loadModules(
          ...
          function (b, c) {
            c = c
              ...
              .setEnum("referrer", a.offerx_referrer)
    ...
    function a(a, b, d) {
      c("Bootloader").loadModules(
        ...
        function (e) {
          ...
          g = s(g, a, b, f);
          if (g) {
            b.getAttribute("data-ploi") &&
              ((g = new Image()), (g.src = new e(t(b))));
            q(a, b, f, d);
          }
        },
        "PhotoSnowliftLoader"
        ...
        function (a) {
          new a("/ajax/photos/snowlift/init.php")
            ...
            .setErrorHandler(function (a) {
              c("FBLogger")("photo_snowlift")
                .catching(a.toError())
                .warn("failed to initialize snowlift");
            })
            .send();
        },
        "PhotoSnowliftLoader"
      ...
      c("ifRequired")("Vector", function (c) {
        ...
        if (d >= b.x || e >= b.y) {
          var f = b.x / b.y,
            g = d / e;
          f < g
            ? ((d = b.x), (e = Math.round(d / g)))
            : f > g
            ? ((e = b.y), (d = Math.round(e * g)))
            : ((d = b.x), (e = b.y));
        }
        return new c(d, e);
      });
    ...
    b = function () {
      c("Arbiter").subscribe(c("PageEvents").BIGPIPE_ONLOAD, function () {
        ...
        ((a && a.classList.contains("home")) ||
          (a && a.classList.contains("timelineLayout"))) &&
          c("ifRequired")(
            "requestIdleCallback",
            function (a) {
              a(function () {
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function l(a, b, c, d) {
      var e = d !== void 0 ? c[d] : c,
        f;
      if (Array.isArray(e)) for (f = 0; f < e.length; f++) l(a, b, e, f);
      else if (e && typeof e === "object")
        if (e.__elem) c[d] = a;
        else if (e.__event) c[d] = b;
        else for (f in e) l(a, b, e, f);
    }
    function m(a, b, e) {
      ...
      e.forEach(function (d) {
        ...
        var e = d.moduleName,
          ...
          m = d.args;
        l(a, b, m);
        var p = c("Bootloader").loadModules.call(
          c("Bootloader"),
          [e],
          function (a) {
            k(g), a[h].apply(a, m);
    ...
    function n(a) {
      var b = a[0],
        c = a[1];
      a = a.slice(2);
      return { moduleName: b, methodName: c, args: a };
    }
    function o(a) {
      var b = a.k,
        c = a.mod,
        d = a.meth;
      a = a.a;
      return { logicalKey: b, moduleName: c, methodName: d, args: a };
    }
    function a(a, b, c) {
      a = d("Parent").byAttribute(a, c);
      if (!a) return null;
      do m(a, b, c);
      while ((a = d("Parent").byAttribute(a.parentNode, c)));
      return !1;
    }
    g.run = a;
  },
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function i(a) {
      ...
      if (a instanceof HTMLElement) return a;
        ...
        c("FBLogger")("ServerCallables").mustfix(
    ...
    function c(a, c, d, e, f) {
      ...
      a == "contextmenu"
        ? b("Arbiter").inform(
            ...
            { cfa: n, node: c, mode: e, event: d, extra_data: f },
            l
          )
        : a == "middleclick"
        ? b("Arbiter").inform(
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h,
      i,
      j,
      k = d("FalcoUtils").getTaggedBitmap(33),
      l = d("FalcoUtils").getTaggedBitmap(0),
      m = 500 * 1024 * 0.6,
      n = new Map(),
      o = new Set([
        "cmcd_messenger_web_logging_event",
    ...
    f = d("FalcoUtils").identityToString(
    ...
    function A(a, b, d, e, f, g) {
      if (
        (i || (i = c("AnalyticsCoreData"))).enable_cmcd_observer &&
        !o.has(a)
      ) {
        a = babelHelpers["extends"](
          { name: a, time: b, sampled: d, getData: f, policy: e },
...
__d(
  ...
  function (a, b, c, d, e, f, g, h) {
    var i,
      j,
      k = c("requireDeferred")("AsyncRequest").__setRef("Primer"),
      l = null,
      m = /async(?:-post)?|dialog(?:-post)?|theater|toggle/;
    a = document.documentElement;
    a != null || h(0, 2301);
    function n(a, b, e, f, g) {
      d("firstClickTimestamp").setIfFirstClick(
        b,
        (i || (i = c("performanceNow")))()
      );
      ...
      switch (p) {
        ...
        case "theater":
          !(j || (j = c("Env"))).isCQuick
            ? d("PhotoSnowliftLoader").load(o, b, f)
            : c("ifRequired")("PageTransitions", function (a) {
                a.go(o);
              });
          break;
        case "toggle":
    ...
    c("Event").listen(
      ...
      function (a) {
        ...
        b instanceof HTMLAnchorElement
          ? (b = n(a, b, l))
          : (b = d("PrimerInlineHandlers").run(l, a, "data-onclick"));
        b == null &&
          (b = d("ReactServerPrimer").handleEvent("data-sr-onclick", a, l));
        return b;
      },
    ...
    c("Event").listen(
      ...
      function (a) {
        ...
        if (b && b.nodeName == "FORM" && (d == "async" || d === "dialog")) {
          ...
          return c("ifRequired")("PageTransitionsRegistrar", function (b) {
    ...
    b = function (a, b) {
      ...
      a === "mouseover" &&
        ...
        c == null &&
          o &&
          (c = d("ReactServerPrimer").handleEvent(
            "data-sr-onmouseover",
            b,
            o
          )));
    ...
    a.onmouseover = c("TimeSlice").guard(
      b.bind(null, "mouseover"),
      "Primer mouseover"
    );
    a.onmouseout = c("TimeSlice").guard(
      e.bind(null, "mouseout"),
      "Primer mouseout"
    );
    f = c("TimeSlice").guard(b.bind(null, "focus"), "Primer focus");
    a.addEventListener
      ? a.addEventListener("focus", f, !0)
      : a.attachEvent("onfocusin", f);
...
__d(
  ...
  function (a, b, c, d, e, f) {
    ...
    n.all = function (a) {
      Array.isArray(a) ||
        (a = [n.reject(new TypeError("Promise.all must be passed an array."))]);
    ...
    n.prototype.done = function (a, c) {
      (g || (g = b("ErrorPubSub"))).reportError(
        b("err")("Promise.done is deprecated. Please use promiseDone.")
      );
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function q(a, b) {
      ...
      b ||
        c("recoverableViolation")(
          "Undefined handler is not allowed",
          "web_speed"
        );
    ...
    function t() {
      ...
      d.onload = c("TimeSlice").guard(function () {
        g && g(),
          c("Arbiter").inform(c("PageEvents").NATIVE_ONLOAD, !0, "state");
      }, "window.onload");
    ...
    function u() {
      ...
      c("Arbiter").inform(c("PageEvents").BIGPIPE_ONLOAD, { ts: b }, "state");
    }
    var v = c("Arbiter").registerCallback(
        function () {
          d("BigPipeInstance").getCurrentInstance()
            ? c("Arbiter").subscribeOnce(
                d("BigPipeInstance").Events.displayed,
                u
              )
            : u();
        },
      ...
      guard: function (a, c, d) {
        ...
        d = function () {
          ...
          if (f != null) {
            ...
            f.isRoot
              ? ((m.indirectParentID = f.contextID), (m.isEdgeContinuation = n))
              : ((m.indirectParentID = f.indirectParentID),
                (m.isEdgeContinuation = !!(n && f.isEdgeContinuation)));
          }
          var r = (k || (k = b("WorkerUtils"))).isWorkerContext();
          p = !0;
          try {
            for (var s = arguments.length, t = new Array(s), v = 0; v < s; v++)
              t[v] = arguments[v];
            if (!m.isRoot || r) return a.apply(this, t);
            else
              return (i || (i = b("ErrorGuard"))).applyWithGuard(a, this, t, {
                name: "TimeSlice" + (c ? ": " + c : ""),
              });
          } finally {
            var x = u();
...
__d(
  "URLFragmentPrelude",
  ["URLFragmentPreludeConfig", "requireWeak"],
  function (a, b, c, d, e, f) {
    a =
      /^(?:(?:[^:\/?#]+):)?(?:\/\/(?:[^\/?#]*))?([^?#]*)(?:\?([^#]*))?(?:#(.*))?/;
    var g = /^[^\/\\#!\.\?\*\&\^=]+$/;
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    b = d("FalcoLoggerInternal").create(
      "browser_permission_policy_client_feature_access",
      a
    );
    e = b;
    g["default"] = e;
...
__d(
  "BrowserFeatureInstrumentation",
  ["BrowserPermissionPolicyClientFeatureAccessFalcoEvent", "killswitch"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    function a(a, b) {
      if (c("killswitch")("SAF_BROWSER_PERMISSIONS_POLICY_CLIENT_LOGGING"))
        return;
      c("BrowserPermissionPolicyClientFeatureAccessFalcoEvent").log(
        function () {
          return {
...
__d(
  "lowerFacebookDomain",
  ["BrowserFeatureInstrumentation", "LowerDomainRegex"],
  function (a, b, c, d, e, f, g) {
    ...
    function a() {
      c("BrowserFeatureInstrumentation")(
        "document-domain",
        "lowerFacebookDomain"
      ),
        (document.domain = h);
...
__d(
  "lowerDomain",
  ["LowerDomainRegex", "lowerFacebookDomain"],
  function (a, b, c, d, e, f, g) {
    ((a = document.domain) != null ? a : "")
      .toLowerCase()
      .match(d("LowerDomainRegex").domainRegex) && c("lowerFacebookDomain")();
  },
  34
);
__d(
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function b(b, d) {
      ...
      for (
        var f = arguments.length, g = new Array(f > 2 ? f - 2 : 0), i = 2;
        i < f;
        i++
      )
        g[i - 2] = arguments[i];
    ...
    function a(a, b) {
      var d,
        e = function () {
          ...
          for (var b = arguments.length, e = new Array(b), f = 0; f < b; f++)
            e[f] = arguments[f];
