...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h,
      i = h || c("react");
    function a(a) {
      return b("cr:8469") != null
        ? b("cr:8469")(a)
        : function (a) {
            return i.jsx(i.Fragment, { children: a });
          };
    }
    g["default"] = a;
  },
      ...
      d.render = function () {
        ...
        j.Children.forEach(f, function (a, f) {
          ...
          if (n % g === 0 || f + 1 === k) {
            if (h === !0 && n < g) {
              for (p = n; p < g; p++)
                m.push(j.jsx(c("GridItem.react"), {}, f + p));
              n = g;
            }
            l.push(j.jsx("tr", { className: "_51mx", children: m }, f));
            m = [];
            n = 0;
          }
        });
        return j.jsx(
          ...
          babelHelpers["extends"]({}, this.props, {
            ...
            cellSpacing: "0",
            cellPadding: "0",
            children: j.jsx("tbody", { children: l }),
          })
        );
      };
      return b;
      ...
      d.render = function () {
        ...
        return b === 0
          ...
          : j.jsxs("div", {
              children: [
                b > 1
                  ? j.jsx(c("PluginTabControl.react"), {
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function (a) {
      ...
      function b(b, d) {
        ...
        d.$PagePluginTabContainer$p_1 = new (c("PagePluginLogger"))(
          b.pageID,
          b.refererURI
        );
        return d;
  ...
  function (a, b, c, d, e, f) {
    ...
    function i(a, c, d) {
      d = b("ReactDOM").render(
        ...
        (a = d) != null
          ? a
          : "ReactRenderer_DEPRECATED.js:renderComponent_DEPRECATED"
      );
      b("cr:3473")(d, c);
      return d;
    }
    ...
    function c(a, c, d, e) {
      a = h.createElement(a, c);
      if (b("gkx")("33087")) {
        return i(
          a,
          d,
          "ReactRenderer_DEPRECATED.js:constructAndRenderComponent_DEPRECATED:" +
            ((c = e) != null ? c : "missing")
        );
      }
      return b("ReactDOM").legacyRender_DEPRECATED(
        a,
        d,
        "ReactRenderer_DEPRECATED.js:constructAndRenderComponent_DEPRECATED:" +
          ((c = e) != null ? c : "missing")
    ...
    e.exports = {
      ...
      constructAndRenderComponent_DEPRECATED: c,
